...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Advantage features */
        {"advantage", "masternode", &masternode, true, true, false},
        {"advantage", "listmasternodes", &listmasternodes, true, true, false},
        {"advantage", "getmasternodecount", &getmasternodecount, true, true, false},
        {"advantage", "masternodeconnect", &masternodeconnect, true, true, false},
        {"advantage", "masternodecurrent", &masternodecurrent, true, true, false},
        {"advantage", "masternodedebug", &masternodedebug, true, true, false},
        {"advantage", "startmasternode", &startmasternode, true, true, false},
        {"advantage", "createmasternodekey", &createmasternodekey, true, true, false},
        {"advantage", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"advantage", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"advantage", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"advantage", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"advantage", "getmasternodescores", &getmasternodescores, true, true, false},
        {"advantage", "mnbudget", &mnbudget, true, true, false},
        {"advantage", "preparebudget", &preparebudget, true, true, false},
        {"advantage", "submitbudget", &submitbudget, true, true, false},
        {"advantage", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"advantage", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"advantage", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"advantage", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"advantage", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"advantage", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"advantage", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"advantage", "checkbudgets", &checkbudgets, true, true, false},
        {"advantage", "mnsync", &mnsync, true, true, false},
        {"advantage", "spork", &spork, true, true, false},
        {"advantage", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"advantage", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use advantaged, or the -server option to advantage-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1: 11235/\n";
}
