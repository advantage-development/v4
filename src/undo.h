...
#ifndef BITCREDIT_UNDO_H
#define BITCREDIT_UNDO_H
 ...
 *  (creditbase or not, height, transaction version)
 */
class CTxInUndo
{
public:
    CTxOut txout;   // the txout data before being spent
    bool fCoinBase; // if the outpoint was the last unspent: whether it belonged to a creditbase
    bool fCoinStake;
