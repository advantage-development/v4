...
/*CScript CChainParams::GetTreasuryRewardScript() const {
	CBitcreditAddress address(treasuryAddress.c_str());
...
public:
    CMainParams()
    {
        ...
        nDefaultPort =  53211;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // AdvantageCoin starting difficulty is 1 / 2^12
		...
		treasuryAddress = "AGgcTyom6bWs7atb37k2c1ZPrUaisPNzRi";
...
public:
    CTestNetParams()
    {
		...
		treasuryAddress = "aWsdgHxx8dCDwBoPEBfGNHPPnLrSUdsr6B";
...
string CChainParams::GetTreasuryRewardAddress() const
{
