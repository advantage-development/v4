...
bool CBudgetProposal::IsValid(std::string& strError, bool fCheckCollateral)
{
    ...
    /*
        TODO: There might be an issue with multisig in the creditbase on mainnet, we will add support for it in a future release.
    */
    ...
    //can only pay out 10% of the possible credits (min value of credits)
