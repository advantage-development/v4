...
{
    BOOST_CHECK(TestSplitHost("www.bitcredit.org", "www.bitcredit.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bitcredit.org]", "www.bitcredit.org", -1));
    BOOST_CHECK(TestSplitHost("www.bitcredit.org:80", "www.bitcredit.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitcredit.org]:80", "www.bitcredit.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1: 53211", "127.0.0.1",  53211));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]: 53211", "127.0.0.1",  53211));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]: 53211", "::ffff:127.0.0.1",  53211));
    BOOST_CHECK(TestSplitHost("[::]: 53211", "::",  53211));
    BOOST_CHECK(TestSplitHost(":: 53211", ":: 53211", -1));
    BOOST_CHECK(TestSplitHost(": 53211", "",  53211));
    BOOST_CHECK(TestSplitHost("[]: 53211", "",  53211));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1: 53211", "127.0.0.1: 53211"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]: 53211", "[::]: 53211"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
