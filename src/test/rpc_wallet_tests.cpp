...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CBitcreditAddress demoAddress = CBitcreditAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CBitcreditAddress setaccountDemoAddress = CBitcreditAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CBitcreditAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CBitcreditAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
