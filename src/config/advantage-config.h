/* src/config/advantage-config.h.  Generated from advantage-config.h.in by configure.  */
/* src/config/advantage-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef USDA_CONFIG_H

#define USDA_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.advantage.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Advantage Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Advantage Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "advantage"
