...
#ifndef BITCREDIT_RPCPROTOCOL_H
#define BITCREDIT_RPCPROTOCOL_H
...
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! Advantage is not connected
