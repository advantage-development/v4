...
/** CCreditsView backed by the LevelDB credit database (chainstate/) */
class CCreditsViewDB : public CCreditsView
{
protected:
    CLevelDBWrapper db;

public:
    CCreditsViewDB(size_t nCacheSize, bool fMemory = false, bool fWipe = false);
