...
QT_MOC_LITERAL(5, 63, 31), // "anonymizeAdvantageAmountChanged"
QT_MOC_LITERAL(6, 95, 28) // "creditControlFeaturesChanged"

    },
    "OptionsModel\0displayUnitChanged\0\0unit\0"
    "obfuscationRoundsChanged\0"
    "anonymizeAdvantageAmountChanged\0"
    "creditControlFeaturesChanged"
};
...
void OptionsModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->anonymizeAdvantageAmountChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->creditControlFeaturesChanged((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OptionsModel::creditControlFeaturesChanged)) {
                *result = 3;
            }
        }
    }
...
// SIGNAL 3
void OptionsModel::creditControlFeaturesChanged(bool _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
