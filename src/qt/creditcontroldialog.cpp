...
void CoinControlDialog::updateLabelLocked()
{
    ...
    model->listLockedCredits(vOutpts);
    if (vOutpts.size() > 0) {
...
void CoinControlDialog::updateView()
{
    ...
    map<QString, vector<COutput> > mapCredits;
    model->listCredits(mapCredits);

    BOOST_FOREACH (PAIRTYPE(QString, vector<COutput>) credits, mapCredits) {
