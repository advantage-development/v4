...
void TransactionView::changedAmount(const QString& amount)
{
    ...
    // Replace "," by "." so BitcreditUnits::parse will not fail for users entering "," as decimal separator
    QString newAmount = amount;
    newAmount.replace(QString(","), QString("."));

    if (BitcreditUnits::parse(model->getOptionsModel()->getDisplayUnit(), newAmount, &amount_parsed)) {
...
void TransactionView::exportClicked()
{
    ...
    writer.addColumn(BitcreditUnits::getAmountColumnTitle(model->getOptionsModel()->getDisplayUnit()), 0, TransactionTableModel::FormattedAmountRole);
...
void TransactionView::computeSum()
{
    ...
    QString strAmount(BitcreditUnits::formatWithUnit(nDisplayUnit, amount, true, BitcreditUnits::separatorAlways));
