...
bool parseBitcreditURI(const QUrl& uri, SendCreditsRecipient* out)
{
    // return if URI is not valid or is no Advantage: URI
    if (!uri.isValid() || uri.scheme() != QString(URI_SCHEME))
        return false;

    SendCreditsRecipient rv;
    rv.address = uri.path();
...
bool parseBitcreditURI(QString uri, SendCreditsRecipient* out)
{
...
QString formatBitcreditURI(const SendCreditsRecipient& info)
{
