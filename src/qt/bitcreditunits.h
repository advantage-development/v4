...
#ifndef BITCREDIT_QT_BITCREDITUNITS_H
#define BITCREDIT_QT_BITCREDITUNITS_H
...
/** Advantage unit definitions. Encapsulates parsing and formatting
...
public:
    ...
    /** Advantage units.
      @note Source: https://en.bitcredit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit {
        USDA,
        mUSDA,
...
#endif // BITCREDIT_QT_BITCREDITUNITS_H
