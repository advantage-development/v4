...
public:
    ...
    void setupUi(QDialog *SendCreditsDialog)
    {
        ...
        frameCoinControl = new QFrame(SendCreditsDialog);
    ...
    void retranslateUi(QDialog *SendCreditsDialog)
    {
        ...
        labelCoinControlFeatures->setText(QApplication::translate("SendCreditsDialog", "Coin Control Features", 0));
        pushButtonCoinControl->setText(QApplication::translate("SendCreditsDialog", "Inputs...", 0));
        labelCoinControlAutomaticallySelected->setText(QApplication::translate("SendCreditsDialog", "automatically selected", 0));
        labelCoinControlInsuffFunds->setText(QApplication::translate("SendCreditsDialog", "Insufficient funds!", 0));
        labelCoinControlQuantityText->setText(QApplication::translate("SendCreditsDialog", "Quantity:", 0));
        labelCoinControlBytesText->setText(QApplication::translate("SendCreditsDialog", "Bytes:", 0));
        labelCoinControlAmountText->setText(QApplication::translate("SendCreditsDialog", "Amount:", 0));
        labelCoinControlPriorityText->setText(QApplication::translate("SendCreditsDialog", "Priority:", 0));
        labelCoinControlPriority->setText(QApplication::translate("SendCreditsDialog", "medium", 0));
        labelCoinControlFeeText->setText(QApplication::translate("SendCreditsDialog", "Fee:", 0));
        labelCoinControlLowOutputText->setText(QApplication::translate("SendCreditsDialog", "Dust:", 0));
        labelCoinControlLowOutput->setText(QApplication::translate("SendCreditsDialog", "no", 0));
        labelCoinControlAfterFeeText->setText(QApplication::translate("SendCreditsDialog", "After Fee:", 0));
        labelCoinControlChangeText->setText(QApplication::translate("SendCreditsDialog", "Change:", 0));
#ifndef QT_NO_TOOLTIP
        checkBoxCoinControlChange->setToolTip(QApplication::translate("SendCreditsDialog", "If this is activated, but the change address is empty or invalid, change will be sent to a newly generated address.", 0));
#endif // QT_NO_TOOLTIP
        checkBoxCoinControlChange->setText(QApplication::translate("SendCreditsDialog", "Custom change address", 0));
