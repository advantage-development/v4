...
public:
    ...
    QCheckBox *creditControlFeatures;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        bitcreditAtStartup = new QCheckBox(tabMain);
        bitcreditAtStartup->setObjectName(QStringLiteral("bitcreditAtStartup"));

        verticalLayout_Main->addWidget(bitcreditAtStartup);
        ...
        anonymizeAdvantage->setMinimum(100);
        anonymizeAdvantage->setMaximum(100000);
        anonymizeAdvantage->setSingleStep(100);
        anonymizeAdvantage->setValue(1000);

        horizontalLayout->addWidget(anonymizeAdvantage);
        ...
        creditControlFeatures = new QCheckBox(groupBox);
        creditControlFeatures->setObjectName(QStringLiteral("creditControlFeatures"));

        verticalLayout_2->addWidget(creditControlFeatures);
...
#ifndef QT_NO_TOOLTIP
        bitcreditAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start Advantage after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        bitcreditAtStartup->setText(QApplication::translate("OptionsDialog", "&Start Advantage on system login", 0));
...
#ifndef QT_NO_TOOLTIP
        creditControlFeatures->setToolTip(QApplication::translate("OptionsDialog", "Whether to show credit control features or not.", 0));
#endif // QT_NO_TOOLTIP
        creditControlFeatures->setText(QApplication::translate("OptionsDialog", "Enable credit &control features", 0));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Advantage network through a SOCKS5 proxy.", 0));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/advantage-project/advantage-project-translations", 0));
...
#ifndef QT_NO_TOOLTIP
        unit->setToolTip(QApplication::translate("OptionsDialog", "Choose the default subdivision unit to show in the interface and when sending credits.", 0));
#endif // QT_NO_TOOLTIP
