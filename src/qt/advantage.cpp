...
void BitcreditApplication::initializeResult(int retval)
{
    ...
    if (retval) {
        ...
        if (pwalletMain) {
            ...
            connect(walletModel, SIGNAL(creditsSent(CWallet*, SendCreditsRecipient, QByteArray)),
                paymentServer, SLOT(fetchPaymentACK(CWallet*, const SendCreditsRecipient&, QByteArray)));
        }
#endif
        ...
        connect(paymentServer, SIGNAL(receivedPaymentRequest(SendCreditsRecipient)),
            window, SLOT(handlePaymentRequest(SendCreditsRecipient)));
