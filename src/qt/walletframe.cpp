...
bool WalletFrame::handlePaymentRequest(const SendCreditsRecipient& recipient)
{
...
void WalletFrame::gotoReceiveCreditsPage()
{
    QMap<QString, WalletView*>::const_iterator i;
    for (i = mapWalletViews.constBegin(); i != mapWalletViews.constEnd(); ++i)
        i.value()->gotoReceiveCreditsPage();
}

void WalletFrame::gotoSendCreditsPage(QString addr)
{
    QMap<QString, WalletView*>::const_iterator i;
    for (i = mapWalletViews.constBegin(); i != mapWalletViews.constEnd(); ++i)
        i.value()->gotoSendCreditsPage(addr);
}
