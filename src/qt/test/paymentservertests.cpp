...
static SendCreditsRecipient handleRequest(PaymentServer* server, std::vector<unsigned char>& data)
{
    RecipientCatcher sigCatcher;
    QObject::connect(server, SIGNAL(receivedPaymentRequest(SendCreditsRecipient)),
        &sigCatcher, SLOT(getRecipient(SendCreditsRecipient)));
    ...
    QObject::disconnect(server, SIGNAL(receivedPaymentRequest(SendCreditsRecipient)),
        &sigCatcher, SLOT(getRecipient(SendCreditsRecipient)));
...
void PaymentServerTests::paymentServerTests()
{
    ...
    SendCreditsRecipient r = handleRequest(server, data);
    QString merchant;
...
void RecipientCatcher::getRecipient(SendCreditsRecipient r)
{
    recipient = r;
}
