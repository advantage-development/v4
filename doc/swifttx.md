...
This mechanism has been integrated into Bitcore-Node-Advantage which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Advantage-Project/insight-api-advantage#web-socket-api](https://github.com/Advantage-Project/insight-api-advantage#web-socket-api) 
* API: [https://github.com/Advantage-Project/insight-api-advantage#swifttx-transactions](https://github.com/Advantage-Project/insight-api-advantage#swifttx-transactions) 
...
By default, the Advantage Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Advantage Core daemon:
